...
module game_datapath (
    ...
    localparam _MP_SIZE_25657044 = 1'h1;
    localparam _MP_DIV_25657044 = 4'hf;
    localparam _MP_TOP_25657044 = 1'h0;
    localparam _MP_UP_25657044 = 1'h1;
    logic [0:0] M_slow_clk_value;
    
    counter #(
        .SIZE(_MP_SIZE_25657044),
        .DIV(_MP_DIV_25657044),
        .TOP(_MP_TOP_25657044),
        .UP(_MP_UP_25657044)
    ) slow_clk (
        .rst(rst),
        .clk(clk),
    ...
    localparam _MP_RISE_679938510 = 1'h1;
    localparam _MP_FALL_679938510 = 1'h0;
    logic M_slow_clk_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_679938510),
        .FALL(_MP_FALL_679938510)
    ) slow_clk_edge (
        .in(M_slow_clk_value),
        .clk(clk),
    ...
    localparam _MP_SIZE_778468121 = 1'h1;
    logic [0:0] M_rng_1_out;
    
    random_number_generator #(
        .SIZE(_MP_SIZE_778468121)
    ) rng_1 (
    ...
    localparam _MP_SIZE_1235280284 = 4'h9;
    logic [8:0] M_rng_500_out;
    
    random_number_generator #(
        .SIZE(_MP_SIZE_1235280284)
    ) rng_500 (
        .slow_clk(M_slow_clk_value),
        .refresh(rst),
        .clk(clk),
