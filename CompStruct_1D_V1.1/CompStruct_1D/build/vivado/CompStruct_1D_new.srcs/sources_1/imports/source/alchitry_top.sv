...
module alchitry_top (
    ...
    localparam _MP_STAGES_452897800 = 3'h4;
    logic M_reset_cond_in;
    logic M_reset_cond_out;
    
    reset_conditioner #(
        .STAGES(_MP_STAGES_452897800)
    ) reset_cond (
        .clk(clk),
        .in(M_reset_cond_in),
    ...
    localparam logic [2:0][23:0] _MP_CLK_FREQ_1201551748 = {{24'h989680, 24'h989680, 24'h989680}};
    localparam _MP_MIN_DELAY_1201551748 = 5'h14;
    localparam _MP_NUM_SYNC_1201551748 = 2'h2;
    logic [2:0] M_p0_button_cond_in;
    logic [2:0] M_p0_button_cond_out;
    
    genvar idx_0_1201551748;
    
    generate
        for (idx_0_1201551748 = 0; idx_0_1201551748 < 3; idx_0_1201551748 = idx_0_1201551748 + 1) begin: forLoop_idx_0_1201551748
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_1201551748[idx_0_1201551748]),
                .MIN_DELAY(_MP_MIN_DELAY_1201551748),
                .NUM_SYNC(_MP_NUM_SYNC_1201551748)
            ) p0_button_cond (
                .clk(clk),
                .in(M_p0_button_cond_in[idx_0_1201551748]),
                .out(M_p0_button_cond_out[idx_0_1201551748])
            );
        end
    endgenerate
    
    
    localparam logic [2:0][23:0] _MP_CLK_FREQ_474455867 = {{24'h989680, 24'h989680, 24'h989680}};
    localparam _MP_MIN_DELAY_474455867 = 5'h14;
    localparam _MP_NUM_SYNC_474455867 = 2'h2;
    logic [2:0] M_p1_button_cond_in;
    logic [2:0] M_p1_button_cond_out;
    
    genvar idx_0_474455867;
    
    generate
        for (idx_0_474455867 = 0; idx_0_474455867 < 3; idx_0_474455867 = idx_0_474455867 + 1) begin: forLoop_idx_0_474455867
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_474455867[idx_0_474455867]),
                .MIN_DELAY(_MP_MIN_DELAY_474455867),
                .NUM_SYNC(_MP_NUM_SYNC_474455867)
            ) p1_button_cond (
                .clk(clk),
                .in(M_p1_button_cond_in[idx_0_474455867]),
                .out(M_p1_button_cond_out[idx_0_474455867])
            );
        end
    endgenerate
    
    
    localparam _MP_CLK_FREQ_1018148339 = 24'h989680;
    localparam _MP_MIN_DELAY_1018148339 = 5'h14;
    localparam _MP_NUM_SYNC_1018148339 = 2'h2;
    logic M_center_button_cond_in;
    logic M_center_button_cond_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_1018148339),
        .MIN_DELAY(_MP_MIN_DELAY_1018148339),
        .NUM_SYNC(_MP_NUM_SYNC_1018148339)
    ) center_button_cond (
        .clk(clk),
    ...
    localparam logic [2:0][0:0] _MP_RISE_1506515520 = {{1'h1, 1'h1, 1'h1}};
    localparam logic [2:0][0:0] _MP_FALL_1506515520 = {{1'h0, 1'h0, 1'h0}};
    logic [2:0] M_p0_button_edge_in;
    logic [2:0] M_p0_button_edge_out;
    
    genvar idx_0_1506515520;
    
    generate
        for (idx_0_1506515520 = 0; idx_0_1506515520 < 3; idx_0_1506515520 = idx_0_1506515520 + 1) begin: forLoop_idx_0_1506515520
            edge_detector #(
                .RISE(_MP_RISE_1506515520[idx_0_1506515520]),
                .FALL(_MP_FALL_1506515520[idx_0_1506515520])
            ) p0_button_edge (
                .clk(clk),
                .in(M_p0_button_edge_in[idx_0_1506515520]),
                .out(M_p0_button_edge_out[idx_0_1506515520])
            );
        end
    endgenerate
    
    
    localparam logic [2:0][0:0] _MP_RISE_1135248729 = {{1'h1, 1'h1, 1'h1}};
    localparam logic [2:0][0:0] _MP_FALL_1135248729 = {{1'h0, 1'h0, 1'h0}};
    logic [2:0] M_p1_button_edge_in;
    logic [2:0] M_p1_button_edge_out;
    
    genvar idx_0_1135248729;
    
    generate
        for (idx_0_1135248729 = 0; idx_0_1135248729 < 3; idx_0_1135248729 = idx_0_1135248729 + 1) begin: forLoop_idx_0_1135248729
            edge_detector #(
                .RISE(_MP_RISE_1135248729[idx_0_1135248729]),
                .FALL(_MP_FALL_1135248729[idx_0_1135248729])
            ) p1_button_edge (
                .clk(clk),
                .in(M_p1_button_edge_in[idx_0_1135248729]),
                .out(M_p1_button_edge_out[idx_0_1135248729])
            );
        end
    endgenerate
    
    
    localparam _MP_RISE_168778825 = 1'h1;
    localparam _MP_FALL_168778825 = 1'h0;
    logic M_center_button_edge_in;
    logic M_center_button_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_168778825),
        .FALL(_MP_FALL_168778825)
    ) center_button_edge (
        .clk(clk),
    ...
    localparam _MP_CLK_FREQ_903715318 = 24'h989680;
    localparam _MP_BAUD_903715318 = 17'h186a0;
    logic M_rx_rx;
    logic [7:0] M_rx_data;
    logic M_rx_new_data;
    
    uart_rx #(
        .CLK_FREQ(_MP_CLK_FREQ_903715318),
        .BAUD(_MP_BAUD_903715318)
    ) rx (
        .clk(clk),
        .rst(rst),
        .rx(M_rx_rx),
    ...
    localparam _MP_CLK_FREQ_520727070 = 24'h989680;
    localparam _MP_BAUD_520727070 = 17'h186a0;
    logic M_tx_tx;
    logic M_tx_block;
    logic M_tx_busy;
    logic [7:0] M_tx_data;
    ...
    uart_tx #(
        .CLK_FREQ(_MP_CLK_FREQ_520727070),
        .BAUD(_MP_BAUD_520727070)
    ) tx (
        .clk(clk),
        .rst(rst),
        .tx(M_tx_tx),
