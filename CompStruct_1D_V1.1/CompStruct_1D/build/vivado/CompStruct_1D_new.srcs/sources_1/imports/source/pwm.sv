...
module pwm #(
    ...
    localparam _MP_SIZE_588465749 = WIDTH;
    localparam _MP_DIV_588465749 = DIV;
    localparam _MP_TOP_588465749 = TOP;
    localparam _MP_UP_588465749 = 1'h1;
    logic [(_MP_SIZE_588465749)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_588465749),
        .DIV(_MP_DIV_588465749),
        .TOP(_MP_TOP_588465749),
        .UP(_MP_UP_588465749)
    ) ctr (
        .clk(clk),
        .rst(rst),
