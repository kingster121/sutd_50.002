...
module pwm #(
    ...
    localparam _MP_SIZE_720895959 = WIDTH;
    localparam _MP_DIV_720895959 = DIV;
    localparam _MP_TOP_720895959 = TOP;
    localparam _MP_UP_720895959 = 1'h1;
    logic [(_MP_SIZE_720895959)-1:0] M_ctr_value;
    
    counter #(
        .SIZE(_MP_SIZE_720895959),
        .DIV(_MP_DIV_720895959),
        .TOP(_MP_TOP_720895959),
        .UP(_MP_UP_720895959)
    ) ctr (
        .clk(clk),
        .rst(rst),
